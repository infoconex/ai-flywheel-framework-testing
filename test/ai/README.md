...
| [Self-Host Certification](prompts/017-self-host-certification.md) | Self-hosted certification assembly with all ten scenarios passed, certification ready for approval, and readiness held pending human authority | No | — | No | Pending final normalized rerun against the immutable evidence revision containing Prompts 001–016 |
