...
| [End-to-End Execution](prompts/010-end-to-end-execution.md) | One stable execution across all lifecycle stages, checkpoint persistence, final durability transactions, and terminal completion | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Resume Interrupted Execution](prompts/011-resume-interrupted-execution.md) | Fresh-session discovery and safe CAS resume of a durable interrupted execution without identity loss, repeated work, stale overwrites, or repository mutation | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Recover Partial Lifecycle Transition](prompts/012-recover-partial-lifecycle-transition.md) | Fresh-session detection and recovery of an execution-first, state-not-written lifecycle transition using a durable transition plan, exact rollback, and structured recovery evidence | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
