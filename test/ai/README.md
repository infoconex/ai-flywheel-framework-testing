...
|---|---|---:|---|---:|---|
| [Startup Validation](prompts/001-startup-validation.md) | Cold start, manifest-first startup, required-file ordering, state resolution, active mission and goal resolution, and startup boundaries | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
