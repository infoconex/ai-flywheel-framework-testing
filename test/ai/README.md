...
| [Adapt to Validate](prompts/007-adapt-to-validate.md) | Adapt completion, validation semantics and evidence requirements, and the transition from Adapt to Validate | Yes | 2026-07-28 | Yes | [View result](results/007-adapt-to-validate.md) |
...
| [Persist to Reuse](prompts/009-persist-to-reuse.md) | Persist completion, structured reuse assessments, knowledge qualification, duplicate/conflict handling, immutable supersession/deprecation, Reuse durability, and terminal closure | Yes | 2026-07-28 | Yes | [View result](results/009-persist-to-reuse.md) |
