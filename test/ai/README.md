...
| [Validate to Persist](prompts/008-validate-to-persist.md) | Validate completion, evidence-backed outcomes, persistence semantics, canonical locations, immutable history, partial-persistence recovery, and repository mutation protection | Yes | 2026-07-28 | Inconclusive | [View latest framework result](results/008-validate-to-persist-rerun-5-2026-07-28.md) |
...
- **Passed** indicates whether the most recent framework execution met the expected result.
- **Test Result** links to the captured result for the most recent framework run. Prompt self-tests are recorded separately and do not change framework-test status.
