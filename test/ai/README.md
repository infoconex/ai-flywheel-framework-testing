...
| [Execute to Observe](prompts/003-execute-to-observe.md) | Non-persistent lifecycle transition, stage ordering, timestamps, state agreement, negative cases, and repository mutation protection | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Observe to Evaluate](prompts/004-observe-to-evaluate.md) | Observation semantics, evidence boundaries, Observe completion, Evaluate activation, traceability, negative cases, and repository mutation protection | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Evaluate to Classify](prompts/005-evaluate-to-classify.md) | Evaluation completion, classification semantics and provenance, multiple classifications, lifecycle ordering, negative cases, and repository mutation protection | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Classify to Adapt](prompts/006-classify-to-adapt.md) | Classification completion, adaptation semantics and provenance, scope and approval boundaries, lifecycle ordering, negative cases, and repository mutation protection | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Adapt to Validate](prompts/007-adapt-to-validate.md) | Adapt completion, validation semantics and evidence requirements, and the transition from Adapt to Validate | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Validate to Persist](prompts/008-validate-to-persist.md) | Validate completion, evidence-backed outcomes, persistence semantics, canonical locations, immutable history, partial-persistence recovery, and repository mutation protection | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [Persist to Reuse](prompts/009-persist-to-reuse.md) | Persist completion, structured reuse assessments, knowledge qualification, duplicate/conflict handling, immutable supersession/deprecation, Reuse durability, and terminal closure | No | — | No | Existing historical result is superseded; pending rerun against the current pinned framework revision |
| [End-to-End Execution](prompts/010-end-to-end-execution.md) | One stable execution across all lifecycle stages, checkpoint persistence, final durability transactions, and terminal completion | Yes | 2026-07-28 | Yes | [View result](results/010-end-to-end-execution.md) |
...
| [Self-Host Certification](prompts/017-self-host-certification.md) | Self-hosted certification assembly with all ten scenarios passed, certification ready for approval, and readiness held pending human authority | Yes | 2026-07-30 | Yes | [View result](results/017-self-host-certification.md) |
