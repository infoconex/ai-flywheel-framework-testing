...
Path: test/ai/prompts/015-recover-broken-active-reference.md
Specification commit: 282edd0103fa75ea308d9d7fcb7737beea5d2b97
...
Write or overwrite only `test/ai/results/015-recover-broken-active-reference.md`. Do not modify `test/ai/README.md`, create alternate results, or modify the framework repository. Commit only the canonical result with message `Replace Prompt 015 verification result`.
